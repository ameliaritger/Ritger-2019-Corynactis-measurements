...
measure_small <- measure %>%
  filter(basal_disk_mm < 10)

# oral disk ~ mouth length, dry mass/wet mass ~ oral disk/mouth length
ggplot(measure_small, aes(x=basal_disk_mm, y=dry_mass_g)) +
  geom_point() +
...
ggsave(here::here("figures", "basal-ww_10.png"), width=10, height=6, dpi=300)
...
ggplot(measure, aes(x=basal_disk_mm, y=wet_mass_g)) +
  #geom_point(aes(color=id)) + # plot points colored by ID
